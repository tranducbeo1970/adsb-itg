 ...
 * @author root
 */
public class PlayItemSamba extends PlayItemBase{
    private SmbFile file;

    public PlayItemSamba() {
    }
    
    public PlayItemSamba(SmbFile file) throws ClassNotFoundException, IOException, IOException {
        this.file = file;
    ...
    protected void load() throws ClassNotFoundException, IOException {
        try {
             //use buffering
            SmbFile smbFile = new SmbFile(this.path, Configuration.getInstance().getAuth());
