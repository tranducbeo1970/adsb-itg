...
public class DataSourceID {
     ...
     * @return 
     */
    public static int decode(byte[] bytes, int index, DataSourceID sourceId) {
    ...
    public static List<Byte> encode(Cat62Message source) {
        if (source == null) return new ArrayList<>();
        return Arrays.asList(new Byte[] {(byte) source.getSac().intValue(), (byte) source.getSic().intValue()});
    }
