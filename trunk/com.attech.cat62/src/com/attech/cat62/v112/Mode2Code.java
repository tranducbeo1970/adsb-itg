...
public class Mode2Code {
    ...
    public void print(int level) {
        String validated = this.notValidated ? "Not validated" : "Validated";
        String garbed = this.garbed ? "Garbed" : "Not garbed";
    ...
    public static int extract(byte [] bytes, int index, Mode2Code code) {
        ...
        int code2Value = (currentByte & 0x08) << 8 | (bytes[index++] & 0xFF);
